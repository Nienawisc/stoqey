...
const LazyCoins = React.lazy((): any => import('../../components/CoinList'));
const LazyTopCoins = React.lazy((): any => import('../../components/TopList'));
const LazyStoqey = React.lazy((): any => import('../../components/Stoqey/StoqeyList'));
const TradesSummary = React.lazy((): any => import('./TradesSummary'));
