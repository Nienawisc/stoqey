...
const Options = () => {
  ...
  return (
    <Form style={{ paddingTop: 10 }}>
      <Text style={{ marginLeft: 16 }} >Delivery metho</Text>
      <Picker
        mode="dropdown"
...
const Recevers = () => {
  ...
  return (
    <TouchableOpacity onPress={() => navigation.navigate('Receiver')}>
      <Form style={{ paddingTop: 10 }}>
        <Text style={{ marginLeft: 16, }} >Select Receiver</Text>
        <Picker
          mode="dropdown"
          iosHeader="Select your SIM"
          iosIcon={<Icon name="arrow-dropdown-circle" style={{ color: "#007aff", fontSize: 25 }} />}
  ...
  return (
    <View style={styles.container}>
      <Content contentContainerStyle={{ padding: 5 }}>
        <View style={{ alignItems: 'center', paddingBottom: 17, }}>
          <Text style={{ fontSize: 25, fontWeight: 'bold', }}> Kenya </Text>
        </View>
        <View style={styles.card}>
          <Form >
            <Text style={{ marginLeft: 16, color: 'white', fontSize: 15, }} >Cash out</Text>
            <Item>
              <Input style={{ width: 200, fontSize: 18, fontWeight: 'bold', color: 'white' }} placeholder="You send" />
            ...
            <Text style={{ marginLeft: 16, paddingTop: 15, color: 'white', fontSize: 15, }} >You get</Text>
            <Item last>
              <Left>
                <Input style={{ width: 200, fontSize: 18, fontWeight: 'bold', color: 'white' }} placeholder="" />
              </Left>
              <Right style={{ flexDirection: 'row', marginLeft: "50%" }}>
                <Text style={[styles.description, { marginBottom: 10, color: 'red' }]} note>CAN</Text>
                <Thumbnail small source={Test} style={{ marginLeft: 10 }} />
      ...
      <View style={styles.sectionFooter}>
        ...
        <PatButton onClick={() => navigation.navigate('ProfileScreen')} style={{ marginLeft: 28, }} buttomText={'Continue to payments'} />
      </View>
    </View>
  );
}
